...
export const authSeed: AuthSeed = {
  ...
  organizers: [
    ...
    { organizerId: "org-004", organizerName: "Kota Panggung", contactEmail: "team@kotapanggung.id", userId: "usr-010" },
    { organizerId: "org-005", organizerName: "Lentera Event", contactEmail: "event@lentera.id", userId: "usr-011" },
  ],
};
